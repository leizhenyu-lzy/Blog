...
class MultiHeadAttention(nn.Module):
    def __init__(self, d_model, n_head, dropout=0.1):
        ...
        self.out_linear = nn.Linear(d_model, d_model)  # 最后还有一层线性映射
    ...
    def forward(self, q, k, v, mask=None):
        ...
        attention_weights = F.softmax(attention_scores, dim=-1)  # (batch_size, n_head, seq_len, seq_len)  # dim=-1 -> 沿着 每个 head 的 行 做 softmax (独立)
